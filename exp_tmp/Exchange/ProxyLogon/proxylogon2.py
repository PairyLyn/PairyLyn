...
legacyDn = (str(ct.content)).split("<LegacyDN>")[1].split("</LegacyDN>")[0]
print("DN: " + legacyDn)
...
#print((str(ct.content)))
#rbacRole = (str(ct.content)).split("RBAC roles:</span> <span class='diagTxt'>")[1].split("</span>")[0]
